...
public class CalcularTabuada extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet CalcularTabuada</title>");            
            out.println("</head>");
            out.println("<body>");
            //out.println("<h1>Servlet CalcularTabuada at " + request.getContextPath() + "</h1>");
            out.println("<h1>Tabuada do "+tab1+"</h1>");
            for (int i = 1; i <= 10; i++) {
                out.println(tab1 + " x " + i + " = " + tab1*i + "<br />");
            }
            out.println("<a href=form_tabuada.html><input type=submit value=Voltar></a>");
